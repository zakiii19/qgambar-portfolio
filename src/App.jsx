...
//               Hai, Jakiwi's here <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5E2CA5] to-indigo-600 dark:from-purple-400 dark:to-indigo-400">Purposeful Design</span>
//             </h1>
