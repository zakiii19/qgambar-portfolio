            ...
            <div className="flex w-max animate-marquee opacity-50 hover:opacity-100 grayscale hover:grayscale-0 transition-all duration-500 cursor-default">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="flex flex-shrink-0 items-center justify-around gap-12 lg:gap-24 px-6 lg:px-12 w-max">
                  ...
                  <div className="flex items-center gap-2"><img src="image/Logo AMJD.SHOOT.png" alt="AMJD.SHOOT Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">AMJD.SHOOT</span></div>
                  <div className="flex items-center gap-2"><img src="image/Logo GANGLIOFID.png" alt="GANGLIOFID Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">GANGLIOFID</span></div>
                  <div className="flex items-center gap-2"><img src="image/Logo CKJ MANAGEMENT.png" alt="CKJ MANAGEMENT Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">CKJ MANAGEMENT</span></div>
                  ...
                  <div className="flex items-center gap-2"><img src="image/Logo PRASADA FUSHION.png" alt="PRASADA FUSHION Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">PRASADA FUSHION</span></div>
                  <div className="flex items-center gap-2"><img src="image/Logo MEGACODIFY.png" alt="MEGACODIFY Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">MEGACODIFY</span></div>
                  <div className="flex items-center gap-2"><img src="image/Logo SCHOOLTECHID.png" alt="SCHOOLTECHID Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">SCHOOLTECHID</span></div>
                  <div className="flex items-center gap-2"><img src="image/Logo VIULA STUDIO.png" alt="VIULA STUDIO Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">VIULA STUDIO</span></div>
                  ...
                  <div className="flex items-center gap-2"><img src="image/Logo INAGO DESIGN.png" alt="INAGO DESIGN Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">INAGO DESIGN</span></div>
                  <div className="flex items-center gap-2"><img src="image/Logo KOLAVIT.png" alt="KOLAVIT Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">KOLAVIT</span></div>
                  <div className="flex items-center gap-2"><img src="image/Logo PUSPAWARNA.png" alt="PUSPAWARNA Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">PUSPAWARNA</span></div>
                </div>
              ))}
            </div>
          </div>
