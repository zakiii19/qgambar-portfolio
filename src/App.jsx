        ...
        <nav className="fixed top-0 w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-50 border-b border-gray-100 dark:border-gray-800 transition-colors duration-300 shadow-sm">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="font-bold text-2xl tracking-tighter text-[#5E2CA5] dark:text-purple-400 cursor-pointer">
              <img src="public/image/vite.svg" alt="Qolbul Muzakilogo" className="w-8 h-8 inline-block mr-2" />
              Qolbul Muzaki
            </div>
            ...
            <div className="flex w-max animate-marquee opacity-50 hover:opacity-100 grayscale hover:grayscale-0 transition-all duration-500 cursor-default">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="flex flex-shrink-0 items-center justify-around gap-12 lg:gap-24 px-6 lg:px-12 w-max">
                  ...
                  <div className="flex items-center gap-2"><img src="public/image/Logo LJH.png" alt="LJH Realty Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">Semarang Kota</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo Platinum.png" alt="Platinum Logo" className='max-h-10'/></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo AMJD.SHOOT.png" alt="AMJD.SHOOT Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">AMJD.SHOOT</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo GANGLIOFID.png" alt="GANGLIOFID Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">GANGLIOFID</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo CKJ MANAGEMENT.png" alt="CKJ MANAGEMENT Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">CKJ MANAGEMENT</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo PHOTO INSTAX SEMARANG.png" alt="PHOTO INSTAX SEMARANG Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">PHOTO INSTAX SEMARANG</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo PRASADA FUSHION.png" alt="PRASADA FUSHION Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">PRASADA FUSHION</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo MEGACODIFY.png" alt="MEGACODIFY Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">MEGACODIFY</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo SCHOOLTECHID.png" alt="SCHOOLTECHID Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">SCHOOLTECHID</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo VIULA STUDIO.png" alt="VIULA STUDIO Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">VIULA STUDIO</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo GUDHA PRANAHARA INDONESIA.png" alt="GUDHA PRANAHARA INDONESIA Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">GUDHA PRANAHARA INDONESIA</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo INAGO DESIGN.png" alt="INAGO DESIGN Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">INAGO DESIGN</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo KOLAVIT.png" alt="KOLAVIT Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">KOLAVIT</span></div>
                  <div className="flex items-center gap-2"><img src="public/image/Logo PUSPAWARNA.png" alt="PUSPAWARNA Logo" className='max-h-10'/><span className="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">PUSPAWARNA</span></div>
                </div>
              ))}
            </div>
          </div>
