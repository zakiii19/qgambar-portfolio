...
export default function App() {
  ...
  const portfolioItems = [
    // UI/UX Projects
    { title: 'NeoBank Dashboard Revamp', category: 'UI/UX', img: 'https://images.unsplash.com/photo-1618761714954-0b8cd0026356?auto=format&fit=crop&w=800&q=80' },
    { title: 'ShopNext Mobile App Flow', category: 'UI/UX', img: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&w=800&q=80' },
    { title: 'LJH Property Portal', category: 'UI/UX', img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80' },
    { title: 'Medica Patient Dashboard', category: 'UI/UX', img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80' },
    
    // Branding Projects
    { title: 'Golden Reunion 50th Logo', category: 'Branding', img: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=800&q=80' },
    { title: 'Quantum Data Identity', category: 'Branding', img: 'https://images.unsplash.com/photo-1613450371465-ee169a71a5c6?auto=format&fit=crop&w=800&q=80' },
    { title: 'Brew & Beans Mascot', category: 'Branding', img: 'https://images.unsplash.com/photo-1629429408209-1f912961bbc3?auto=format&fit=crop&w=800&q=80' },
    { title: 'GreenEarth Guidelines', category: 'Branding', img: 'https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?auto=format&fit=crop&w=800&q=80' },
    
    // Packaging Projects
    { title: 'Rice Bowl Die-cut Sleeve', category: 'Packaging', img: 'https://images.unsplash.com/photo-1628102491629-778571d893a3?auto=format&fit=crop&w=800&q=80' },
    { title: 'Peak Roast Coffee Bags', category: 'Packaging', img: 'https://images.unsplash.com/photo-1606240724602-5b21f896eae8?auto=format&fit=crop&w=800&q=80' },
    { title: 'Aura Cosmetics Labels', category: 'Packaging', img: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=800&q=80' },
    { title: 'NatureBites Snack Box', category: 'Packaging', img: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=800&q=80' },
    
    // Print Projects
    { title: 'SchoolTechId Marketing', category: 'Print', img: 'https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&w=800&q=80' },
    { title: 'Luxury Villa Catalog', category: 'Print', img: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&w=800&q=80' },
    { title: 'UNNES Tech Seminar Poster', category: 'Print', img: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&w=800&q=80' },
    { title: 'Summer Fest Brochure', category: 'Print', img: 'https://images.unsplash.com/photo-1542744094-3a31f272c490?auto=format&fit=crop&w=800&q=80' }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {filteredPortfolio.map((item, idx) => (
                <div key={idx} className="group relative rounded-3xl overflow-hidden cursor-pointer bg-gray-100 dark:bg-gray-800 aspect-[4/3]">
            ...
            <div className="mt-12 text-center">
              <button className="inline-flex items-center gap-2 text-[#5E2CA5] dark:text-purple-400 font-bold hover:text-[#4a2384] dark:hover:text-purple-300 transition-colors">
          ...
          <div className="max-w-5xl mx-auto grid lg:grid-cols-5 gap-16">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-6">
                <a href="mailto:hello@qolbulmuzaki.my.id" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                  ...
                  <div>
                    ...
                    <span className="font-semibold">hello@qolbulmuzaki.my.id</span>
                  </div>
                </a>
              </div>
                ...
                <div className="flex gap-4">
                  {[
                    ...
                    <a 
                      ...
                      href="#" 
                      title={platform.name}
                      className="group flex items-center justify-center w-12 h-12 rounded-full bg-gray-900/50 border border-gray-800 text-gray-400 hover:bg-[#5E2CA5] hover:text-white hover:border-[#5E2CA5] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_15px_-3px_#5E2CA5]"
                    >
                      {platform.icon}
                    </a>
                  ))}
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" placeholder="John Doe" className="w-full bg-gray-950 border border-gray-800 rounded-xl p-4 text-white focus:outline-none focus:border-[#5E2CA5] focus:ring-1 focus:ring-[#5E2CA5] transition-all" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-400">Email Address</label>
                    <input type="email" placeholder="john@example.com" className="w-full bg-gray-950 border border-gray-800 rounded-xl p-4 text-white focus:outline-none focus:border-[#5E2CA5] focus:ring-1 focus:ring-[#5E2CA5] transition-all" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-400">Service Needed</label>
                  <select className="w-full bg-gray-950 border border-gray-800 rounded-xl p-4 text-gray-300 focus:outline-none focus:border-[#5E2CA5] focus:ring-1 focus:ring-[#5E2CA5] transition-all appearance-none">
                ...
                <div className="space-y-2">
                  ...
                  <textarea placeholder="Tell me about your project timeline and goals..." rows="4" className="w-full bg-gray-950 border border-gray-800 rounded-xl p-4 text-white focus:outline-none focus:border-[#5E2CA5] focus:ring-1 focus:ring-[#5E2CA5] transition-all resize-none"></textarea>
                </div>
                <button className="w-full bg-[#5E2CA5] hover:bg-[#4a2384] transition-colors text-white font-bold py-4 rounded-xl shadow-lg shadow-purple-900/50 flex justify-center items-center gap-2">
